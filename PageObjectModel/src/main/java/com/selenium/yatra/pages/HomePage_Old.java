...
public class HomePage_Old extends BasePage{
	...
	public HomePage_Old(WebDriver driver, ExtentTest test){
		super(driver, test);
	...
	//public SearchFlightsPage goToSearchFlightsPage() throws InterruptedException{
	public Object goToSearchFlightsPage() throws InterruptedException{
		if(loginFlag){
			Actions loginAction = new Actions(driver);
			loginAction.moveToElement(myAccountLink).build().perform();
			//SearchFlightsPage sfp = PageFactory.initElements(driver, SearchFlightsPage.class);
			//driver.findElement(By.cssSelector("li#userLoginBlock>a"))
			//return sfp;
...
//		driver.findElement(By.xpath("klp'/P;/")).click();
		driver.findElement(By.xpath("//table/tbody/tr/td[@data-date='10/09/2020']")).click();
		driver.findElement(By.xpath("//table/tbody/tr/td[@data-date='18/09/2020']")).click();
